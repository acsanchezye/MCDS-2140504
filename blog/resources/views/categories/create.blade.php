            ...
            <nav aria-label="breadcrumb">
             ...
             <form method="POST" action="{{ route('categories.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                                ...
                                is-invalid @enderror" name="name" value="{{ old('name') }}" placeholder="@lang('general.label-name')" autofocus>
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                                <div class="text-center my-3">
                                    <img src="{{ asset('imgs/sinfoto.png') }}" class="img-thumbnail" id="preview" width="120px">
                                </div>
